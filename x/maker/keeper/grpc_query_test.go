...
func (suite *KeeperTestSuite) TestAllBackingPools() {
	...
	poolBacking := types.PoolBacking{
		BlackMinted:  sdk.NewCoin(blackfury.MicroFUSDDenom, sdk.NewInt(100)),
	...
	poolBacking2 := types.PoolBacking{
		BlackMinted:  sdk.NewCoin(blackfury.MicroFUSDDenom, sdk.NewInt(200)),
...
func (suite *KeeperTestSuite) TestAllCollateralPools() {
	...
	poolColl := types.PoolCollateral{
		...
		BlackDebt:            sdk.NewCoin(blackfury.MicroFUSDDenom, sdk.NewInt(100)),
	...
	poolColl2 := types.PoolCollateral{
		...
		BlackDebt:            sdk.NewCoin(blackfury.MicroFUSDDenom, sdk.NewInt(200)),
