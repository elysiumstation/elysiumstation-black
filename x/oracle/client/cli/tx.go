...
# Aggregate Prevote
$ blackfuryd tx oracle aggregate-prevote 1234 afury:1.234,ufusd:0.99
...
$ blackfuryd tx oracle aggregate-prevote 1234 afury:1.234,ufusd:0.99 blackvaloper1...
`),
...
$ blackfuryd tx oracle aggregate-vote 1234 afury:1.234,ufusd:0.99
...
If voting from a voting delegate, set "validator" to the address of the validator to vote on behalf of:
$ blackfuryd tx oracle aggregate-vote 1234 afury:1.234,ufusd:0.99 blackvaloper1...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
